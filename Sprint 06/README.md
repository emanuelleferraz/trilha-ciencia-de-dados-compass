...
Seguindo o mesmo esquema dos cursos anteriores, como não foram feitos exercícios, estarei inserindo os notebooks referentes as aulas práticas do curso.

1. **OpenCV**:

    ➡️ Confira o notebook de [valores e pixels](./exercicios/curso%20de%20reconhecimento%20facial/openCV/01-values-pixels.ipynb).

    ➡️ Confira o notebook de [lendo a imagem](./exercicios/curso%20de%20reconhecimento%20facial/openCV/02-reading-image.ipynb).

    ➡️ Confira o notebook de [redimensionando a imagem](./exercicios/curso%20de%20reconhecimento%20facial/openCV/03-image-resizing.ipynb).

    ➡️ Confira o notebook de [detecção de face](./exercicios/curso%20de%20reconhecimento%20facial/openCV/04-face-detection.ipynb).

2. **Face Recognition with Machine Learning**:

    ➡️ Confira o notebook de [cortando as faces (pré-processamento)](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/01-pre-processamento-crop.ipynb).

    ➡️ Confira o notebook de [EDA](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/02-pre-processamento-eda.ipynb).

    ➡️ Confira o notebook de [eigen image](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/03-feature-extraction-eigen.ipynb).

    ➡️ Confira o notebook de [treinando com machine learning](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/04-machine-learning.ipynb).

    ➡️ Confira o notebook de [pipeline de face recognition](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/05-pipeline.ipynb).

    ➡️ Confira o notebook de [previsão](./exercicios/curso%20de%20reconhecimento%20facial/face%20recognition%20machine%20learning/06-predict.ipynb).

Um ponto importante a se destacar nesse tópico de exercícios é que, do curso de Face Recognition não estarão os notebooks da seção referente ao desenvolvimento de um aplicativo web para detecção de faces. Outro ponto, é que no curso de NLP, não consegui realizar as aulas no Databricks, uma vez que não me possibilitaram a criação de um Cluster (curso é antigo, mudaram algumas coisas). Da mesma forma, tive problemas com a seção final do curso de MLOps e não consegui usar o modelo implantado no pequeno código python feito ao final.
...
Melhor modelo:
O último modelo (27,64,12,197) teve:

- Menor número de Falsos Negativos (12) → Ele errou menos ao não identificar positivos.
- Maior número de Verdadeiros Positivos (197) → Ele acertou mais previsões positivas.
...
### Face Recognition with Machine Learning
O curso de Face Recognition foi bem interessante, abordando temas desde a detecção com OpenCV até a detecção com modelos de Machine Learning.

- **OpenCV**: Sobre a detecção com OpenCV, um dos pontos que foi bem legal inicialmente, foi poder conhecer mais sobre como o padrão RGB modifica as imagens. Nessa seção, foram feitos transformações usando bibliotecas como o OpenCV propriamente, Matplotlib e Pillow. O OpenCV lê a imagem com padrão BGR, diferentemente do Matplotlib e Pillow que leem com RGB. Na imagem abaixo isso é reforçado.
